...
//
//  Created by Pluto Y on 24/03/2017.
...
@IBDesignable class GraphView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // 1 - save the state of the context (comment out for now)
//        CGContextSaveGstate(context)
        ...
        // center line 
        linePath.move(to: CGPoint(x: margin, y: topBorder + graphHeight / 2.0))
        linePath.addLine(to: CGPoint(x: width - margin, y: topBorder + graphHeight / 2.0))
        
        // bottom line
        linePath.move(to: CGPoint(x: margin, y: topBorder + graphHeight))
        linePath.addLine(to: CGPoint(x: width - margin, y: topBorder + graphHeight))
